  ...
  return (
    <div >
      ...
      {hideDetail ? <ul> {heroInfo} </ul> : (<ul className={Style.detailImg}>
        ...
        {data?.comics == "Villains" && <p>Villains from the Marvel comic book universe. Some of these villains are restricted to one series.</p> ||
         data?.comics == "Marvel" && <ul className={Style.marvelChars}><li>Avengers</li><li>Guardians Of The Galaxy</li><li>X-men</li><li>Eternals</li></ul> || getFounder}
